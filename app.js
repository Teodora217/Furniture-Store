// 1. Get all HTML needed for manipulation
// 2. Created addFurniture function that gets all data and creates the proper HTML.
// 3. Create more info visualization and button text function handler
...
function solve() {
  ...
  function buyFurniture(e) {
    ...
    totalPrice.textContent = (Number(totalPrice.textContent) + price).toFixed(
      2
    );
